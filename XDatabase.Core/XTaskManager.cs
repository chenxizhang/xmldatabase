    ...
    class XTaskManager
    {
        ...
        public XSubmitStatus Execute(bool continueOnError,bool hasTransaction) {
            ...
            foreach (var item in tasks)
            {
                ...
                {
                    hasError = true;
                    sb.AppendFormat(Properties.Resources.ChangeActionError,
        ...
        private void AddOrUpdateObject(object o) {
            ...
            if (id != Guid.Empty)
            {
                ...
                //编写日志
                internaldb.Log.WriteEx(string.Format(Properties.Resources.UpdateObject, id, o.ToString()));
            }
            else
            { 
                //新增
                ...
                //编写日志
                internaldb.Log.WriteEx(string.Format(Properties.Resources.InsertObject, id, o.ToString()));
            }
        ...
        private void DeleteObject(object o) {
            ...
            internaldb.Log.WriteEx(string.Format(Properties.Resources.DeleteObject, id, o));
